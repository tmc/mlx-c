...
// Needed unconditionally: the extern "C" stub below references mlx_array even
// when the trace runtime is compiled out.
...
#else  // !MLX_STREAM_TRACE_BUILD

extern "C" uint64_t mlx_stream_trace_array_handle_generation(mlx_array arr) {
  (void)arr;
  return 0;  // tracing not built in; report generation 0
}

#endif  // MLX_STREAM_TRACE_BUILD
